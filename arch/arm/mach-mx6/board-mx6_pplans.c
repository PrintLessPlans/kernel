...
static struct fb_videomode pplans_mode = {
        .name = "PPLANS",
        .refresh = 85,
        .xres = 1440,
        .yres = 960,
...
#endif
	mxc_iomux_set_gpr_register(1, 13, 1, 1);	//USB otg id GPIO_1 
...
static void __init imx6q_i2c_gpio(void)
{
